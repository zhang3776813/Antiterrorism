...
public class JKCKMenuActivity extends BasicActivity {
    ...
    private void initMenu() {
        ...
        rv_recycler.setAdapter(AdapterFactory.getAdapterByType(context, Constants.ADAPTER_JKCK_MENU, null, null, null,null));
    }
}
