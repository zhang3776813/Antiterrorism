 ...
 */
@ContentView(R.layout.activity_qtycsb)
public class QTYCSBActivity extends BasicActivity {

    //其他异常情况描述
    @ViewInject(R.id.et_ycqkms)
    private EditText et_ycqkms;
