...
public class DZJGActivity extends BasicActivity {
    ...
    private void initMenu() {
        ...
        rv_recycler.setAdapter(AdapterFactory.getAdapterByType(context, Constants.ADAPTER_DZJG_MENU, null, null, null));
    }
}
