...
public class JDWLActivity extends BasicActivity {
    ...
    private void initMenu() {
        ...
        rv_recycler.setAdapter(AdapterFactory.getAdapterByType(context, Constants.ADAPTER_JDWL_MENU,null,null,null));
    }
}
