...
public class ZDDWActivity extends BasicActivity {
    ...
    private void initMenu() {
        ...
        rv_recycler.setAdapter(AdapterFactory.getAdapterByType(context, Constants.ADAPTER_ZDDW_MENU, null, null, null));
    }
}
