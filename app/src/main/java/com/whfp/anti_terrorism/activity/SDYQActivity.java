...
public class SDYQActivity extends BasicActivity {
    ...
    private void initMenu() {
        ...
        rv_recycler.setAdapter(AdapterFactory.getAdapterByType(context, Constants.ADAPTER_SDYQ_MENU,null,null,null));
    }
}
