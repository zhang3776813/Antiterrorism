...
import com.whfp.anti_terrorism.callback.MultipleRefreshCallBack;
...
public abstract class BasicMultipleRecyclerRefreshFragment extends BaseFragment implements MultipleRefreshCallBack, OnRefreshListener, OnLoadMoreListener {
...
//        refreshLayout.autoRefresh();
    ...
    private void initAdapter() {
        adapter = (BaseMultiItemQuickAdapter) getAdapter();
        //设置空布局
